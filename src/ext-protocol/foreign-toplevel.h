...
void handle_foreign_destroy(struct wl_listener *listener, void *data) {
	...
	listener_unlink(&c->foreign_activate_request);
	listener_unlink(&c->foreign_minimize_request);
	listener_unlink(&c->foreign_maximize_request);
	listener_unlink(&c->foreign_fullscreen_request);
	listener_unlink(&c->foreign_close_request);
	listener_unlink(&c->foreign_destroy);
